...
namespace TrainTicketSales.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserName,FullName,Password,DateOfBirth,Sex,Email,IsActive")] Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserName,FullName,Password,DateOfBirth,Sex,Email,IsActive")] Users users)
        {
